    ...
    return JSONResponse(
        {
            ...
            "easy_turn": {
                ...
                "preload": EASYTURN_PRELOAD,
                "checkpoint_configured": bool(EASYTURN_CHECKPOINT),
                "llm_path_configured": bool(EASYTURN_LLM_PATH),
                "ack_text": EASYTURN_ACK_TEXT,
                "max_audio_seconds": EASYTURN_MAX_AUDIO_SECONDS,
                "startup": getattr(request.app.state, "easy_turn", None),
            },
